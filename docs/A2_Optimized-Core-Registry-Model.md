A2_Optimized\Core\Registry\Model
===============
...
### set
    ...
    void A2_Optimized\Core\Registry\Model::set(string $key, mixed $value)
...
### get
    ...
    mixed A2_Optimized\Core\Registry\Model::get(string $key)
...
### get_all_objects
    ...
    array A2_Optimized\Core\Registry\Model::get_all_objects()
