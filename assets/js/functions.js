...
jQuery(document).ready(function($) {
    if (filename == 'update-core.php' && $('form.upgrade').length > 0) {
        ...
        $('ul.core-updates').prepend('<div id="w3tc-warning" class="notice notice-error"><p>W3 Total Cache may cause issues during major WordPress core updates. We recommend you <a href="/wp-admin/plugins.php">disable W3 Total Cache</a> before continuing. Please remember to re-activate it after the update.</p><p><a href="#" id="upgrade-confirm" class="button">I understand the risks, let me update</a></p></div>');
    }
