...
# main config
PLUGINSLUG="a2-optimized-wp"
CURRENTDIR=`pwd`
MAINFILE="a2-optimized.php" # this should be the name of your main php file in the wordpress plugin
...
SVNUSER="a2hosting" # your svn username
